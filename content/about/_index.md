...
public key [4474 02D1 4A39 CD2F 1574 4A7B 1456 79F5 FD01 E64A](./pubkey.asc)

### **Projects**

- I've designed and built the product suite for [Polia](https://polia.io) — a real-time web3 market data aggregator.
- [aave-liquidation](https://github.com/lbkolev/aave-liquidation): full-fledged AaveV3 liquidation bot.
- [dessert](https://github.com/lbkolev/dessert): 16bit stack-based VM.
- [threadpool](https://github.com/lbkolev/threadpool): threadpool executor for Rust.
- [eventify](https://github.com/lbkolev/eventify): Ethereum/EVM event ETL pipeline.
- [terraform-aws-eth-node](https://github.com/lbkolev/terraform-aws-eth-node): Terraform module for Ethereum node deployment on AWS.
